...
namespace moj_harness {
	...
	int run_test_case(int casenum__) {
		...
		case 0: {
			...
			int received__            = Salary().howMuch(vector <string>(arrival, arrival + (sizeof arrival / sizeof arrival[0])), vector <string>(departure, departure + (sizeof departure / sizeof departure[0])), wage);
